    ...
    <Box id="contact">
      ...
      >
        ...
        <Text variant="p" className="myproject">
          ...
          proyectos está almacenada en un archivo JSON y es recuperada mediante
          la función fetch, permitiendo una gestión dinámica de los datos.
          Además, para mejorar la experiencia de usuario, implementé animaciones
          y transiciones mediante CSS e integré la librería Framer Motion para
